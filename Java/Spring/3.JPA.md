...
* [Customised Method in JPA](#customised-method-in-jpa)
  * [Derived Query Methods (Method Name Convention)](#Derived-Query-Methods-(Method-Name-Convention))
  * [JPQL (Java Persistence Query Language) with @Query Annotation](#JPQL-(Java-Persistence-Query-Language)-with-@Query-Annotation)
  * Native SQL Queries
  * Criteria API (Dynamic Queries in Java Code)
...
#### Derived Query Methods (Method Name Convention)
...
#### JPQL (Java Persistence Query Language) with @Query Annotation
